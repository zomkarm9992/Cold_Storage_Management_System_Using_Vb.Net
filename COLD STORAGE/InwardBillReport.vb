...
Public Class InwardBillReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "COLD_STORAGE.InwardBillReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInwardBillReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InwardBillReport = New InwardBillReport
        rpt.Site = Me.Site
        Return rpt
    End Function

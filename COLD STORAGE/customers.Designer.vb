...
Partial Public Class customers
    ...
    Partial Public Class customerTableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddcustomerTableRow(ByVal Id As String, ByVal Name As String, ByVal Address As String, ByVal PhNo As String, ByVal Gender As String) As customerTableRow
            Dim rowcustomerTableRow As customerTableRow = CType(Me.NewRow,customerTableRow)
            Dim columnValuesArray() As Object = New Object() {Id, Name, Address, PhNo, Gender}
    ...
    Partial Public Class customerTableRow
        ...
        Public Property Id() As String
            Get
                Return CType(Me(Me.tablecustomerTable.IdColumn),String)
            End Get
            Set
...
Namespace customersTableAdapters
    ...
    Partial Public Class customerTableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[customerTable] ([Id], [Name], [Address], [PhNo], [Gender]) VAL"& _ 
                "UES (@Id, @Name, @Address, @PhNo, @Gender)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Name, Address, PhNo, Gender FROM dbo.customerTable"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As customers.customerTableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As customers.customerTableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As customers.customerTableDataTable = New customers.customerTableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As customers.customerTableDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Id As String, ByVal Name As String, ByVal Address As String, ByVal PhNo As String, ByVal Gender As String) As Integer
